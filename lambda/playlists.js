...
module.exports.cleanStringPlaylistName = function cleanStringPlaylistName(playlistName) {
    ...
    if(playlistName.toLocaleLowerCase().includes('add song to ')| playlistName.toLocaleLowerCase().includes('add song to')) {
...
module.exports.isValidPlaylist = function isValidPlaylist(playlistName) {
    ...
    cleanedPlaylists.forEach(function (value, key) {
        if(playlistMatch.get(value) == null) {
            ...
            console.log('Valid playlistName', value, " with match of: ", playlistMatch.get(value)[0][0]);
            validPlaylist = true;
